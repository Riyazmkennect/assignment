        ...
        <div class="space-y-2">
          ...
          <input
            ...
            class="
              ...
              rounded
              focus:border-transparent focus:outline-none focus:shadow-outline
              px-3
              py-2
            "
            placeholder="hey@User.com"
          />
          <label for="AccountType" class="block font-medium tracking-tight"
            >Account Type</label
          >
          <input
            v-model="AccountType"
